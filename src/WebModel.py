...
class WebModel():
    ...
    QUNAR_COMMON_HOST = 'train.qunar.com'
    QUERY_FULL_TRAIN_NO_URL = '/qunar/checiSuggest.jsp?include_coach_suggest=false&lang=zh&q={0}&sa=true&format=js&callback=NIMA'
    QUERY_TRAIN_STATIONS_URL = '/qunar/checiInfo.jsp?method_name=buy&ex_track=&q={0}&date=&format=json&cityname=123456&ver=1420092773443&callback=NIMA'
